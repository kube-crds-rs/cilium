...
// kopium command: kopium -f envoyconfigs.yml --schema=derived --docs -b --derive=Default --derive=PartialEq --smart-derive-elision
...
pub struct CiliumEnvoyConfigSpec {
    ...
    pub backend_services: Option<Vec<CiliumEnvoyConfigBackendServices>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[cfg_attr(feature = "builder", builder(default, setter(strip_option)))]
    pub services: Option<Vec<CiliumEnvoyConfigServices>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
#[cfg_attr(feature = "builder", derive(TypedBuilder))]
#[cfg_attr(feature = "schemars", derive(JsonSchema))]
pub struct CiliumEnvoyConfigBackendServices {
...
#[cfg_attr(feature = "builder", derive(TypedBuilder))]
#[cfg_attr(feature = "schemars", derive(JsonSchema))]
pub struct CiliumEnvoyConfigServices {
